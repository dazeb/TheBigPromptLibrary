...
| Destination | Relative volume | What it's for |
|-------------|-----------------|---------------|
...
You don't have to speculate about intent to find it notable that your local CLI ships remote-controlled behavior flags with names like *"anti-distill fake tool injection."* These names are community-observed rather than documented, and they churn between releases — hence the **[FLAG]** marker on this section.
